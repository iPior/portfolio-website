...
export function Hero() {
  return (
      ...
      <section id="hero" className="mx-auto w-full">
        <p className="text-md md:text-xl text-muted-foreground w-full font-bold mt-18 md:mt-24 px-2 md:px-4">Hi, I'm</p>
        <BorderWrapper className="px-1 md:px-2 pb-2 xs:pb-3 sm:pb-4 lg:px-1 lg:pb-6 font-extrabold text-7xl xs:text-8xl sm:text-9xl lg:text-hero uppercase">
