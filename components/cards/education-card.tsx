...
export default function EducationCard({ className }: EducationCardProps) {
  ...
  return (
    <Card
      className={cn(
        "group h-full bg-transparent md:hover:bg-muted/90 md:bg-card md:border border-0 p-0 md:py-6 shadow-none md:shadow-sm",
        className
      )}
    >
      <CardContent className="p-4 md:p-6">
        <div className="group-hover:scale-105 group-hover:translate-x-3 transition-transform duration-200 ease-in-out">
